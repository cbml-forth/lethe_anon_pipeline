...
### <a name="clinical"></a>Clinical data
...
│ study-info      Extract and print the unique Study descriptions from input DICOM files             │
│ export-lookup   Export the mappings from source patient ids to the pseudonymized ones              │
╰────────────────────────────────────────────────────────────────────────────────────────────────────╯
```
...
The `utils study-info` command can be similarly used to get an overview of all the DICOM Studies that can be found in an input folder. By default it prints a table like this:

```

                                                     Study information
┏━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
┃ PatientID  ┃ StudyUID                                                         ┃ StudyDate ┃ StudyDescription             ┃
┡━━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╇━━━━━━━━━━━╇━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┩
│ 3209648408 │ 1.2.826.0.1.3680043.8.498.10492038307422868223199863260233355278 │ 19990923  │ CT UROGRAM                   │
│ 3209648408 │ 1.2.826.0.1.3680043.8.498.15325708537294505104277328793123984041 │ 19990923  │ CT UROGRAM                   │
│ 571403367  │ 1.2.826.0.1.3680043.8.498.11930027078857085215653760141431432752 │ 20190711  │ DBT Reconstructed Volume     │
│ 571403367  │ 1.2.826.0.1.3680043.8.498.43140369966073420105378776118739847239 │ 20190711  │ DBT Reconstructed Volume     │
│ 571403367  │ 1.2.826.0.1.3680043.8.498.60031442536880637581306951540659454726 │ 20190711  │ DBT Reconstructed Volume     │
│ 8732322741 │ 1.2.826.0.1.3680043.8.498.11505123464109404670942682899455583584 │ 20080105  │ MRI PROSTATE W WO CONTRAST   │
│ 9894340694 │ 1.2.826.0.1.3680043.8.498.10976157236759544945657408266559980502 │ 19970416  │ MRI ABDOMEN PELVIS W+WO CONT │
└────────────┴──────────────────────────────────────────────────────────────────┴───────────┴──────────────────────────────┘
```

If you supply the `--csv` option to `utils study-info` will instead print the study information in CSV format. In this case, in addition to `PatientID`, `StudyUID`, `StudyDate`, and `StudyDescription`, it will also include two empty columns: `Episode` and `ImagingTimepoint`. Users can save the output CSV data to a file called `dcm_studies_metadata.csv`, edit it appropriately to include the episode and timepoint information, and copy it to the input folder so that a subsequent `run` launch of Lethe can use it as "clinical data" as explained [above](#clinical)
